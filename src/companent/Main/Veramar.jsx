  ...
  return (
    <div id='veramar'>
        ...
        <div className='px-6 mt-12 mx-auto w-[90%]'>
          <div className='bg-[#d0c5ad] mini:w-[85%] tablet:w-[50%] text-[35px] tablet:text-[55px] mb-4 text-center mx-auto my-1 '  style={{ fontFamily: "'Frunchy', sans-serif" }}>Nuestros Pilares</div>
